...
global Output C:\Users\wb570559\github\india_air_pollution\results\tables

* Load Data
use "$Data\temp_data\tempdata_yearly_juris_pol_with_len_heurs.dta"
...
*lndu lnoc14 lnoc16 lnoc18 lnpm14 lnpm16 lnpm18 lnso2 lnso4 lnss
forvalues p = 1/3{
...
foreach rv of varlist lnbc lndu lnoc14 lnoc16 lnoc18 lnpm14 lnpm16 lnpm18 lnso2 lnso4 lnss {
	...
	quietly ivreg2 `rv' (FracGreenCases_lag_`p' = d2v_vec*_len_heur_lag_`p' JudgePG_len_heur_lag_`p' JudgeW_len_heur_lag_`p') CaseDummy_lag_`p' GovtResp_len_heur_lag_`p' Appeal_len_heur_lag_`p' Const_len_heur_lag_`p' i.district_encoded i.year, cluster(cluster_sp_lag_`p') robust small partial(i.district_encoded i.year)
	...
	* Estimate CI sets
	quietly twostepweakiv 2sls `rv' CaseDummy_lag_`p' GovtResp_len_heur_lag_`p' Appeal_len_heur_lag_`p' Const_len_heur_lag_`p' i.district_encoded i.year (FracGreenCases_lag_`p' = d2v_vec*_len_heur_lag_`p' JudgePG_len_heur_lag_`p' JudgeW_len_heur_lag_`p'), cluster(cluster_sp_lag_`p') robust small partial(i.district_encoded i.year) gridmult(10) gridpoints(1000)
