...
class preprocessor():
    ...
    def merge_function(self):
        ...
        faulty_dist_dict = {'guwahati': 'kamrup',
         ...
         'belagavi': 'belgaum',
         'budgam': 'budgam',
         'budge budge': 'south 24 paraganas',
         'bombay': 'mumbai',
         ...
         'dighi': 'pune',
         'panji': 'north goa',
         'chikkaballapura': 'bangalore north'}
        ...
        casedata_path = self.root_res_data + "/case_data_final.csv"
        ...
        df_air_pollution_gpby_district_year = df_air_pollution.groupby(["district", "year"]).agg("mean")
        ...
        df_monthly_merge.to_csv(self.root_res_data+"/monthly_air.csv", index = "False")
        
        df_yearly_merge.to_csv(self.root_res_data+"/yearly_air.csv", index = "False")
