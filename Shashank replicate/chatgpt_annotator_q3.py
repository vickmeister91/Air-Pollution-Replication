...
question = "In the following judgement order summary, did the court tell the respondent to follow the law, or did the court tweak the law in its judgement? Give a binary answer, 'follow' or 'tweak' and then give the reason separated from the binary answer with a colon. The order is as follows - "
...
# list_paths = glob.glob(wd+r"/q3responses/*.txt")
list_done = []
# for path in list_paths:
