...
question = "In the following judgement order summary, did the court’s decision compel action by a politician or regulator? Give a binary answer, yes or no and then describe the action separated from the binary answer with a colon. The order is as follows - "
...
list_paths = glob.glob("/Users/shashanksingh/Desktop/India_air/q4responses/*.txt")
list_done = []
for path in list_paths:
...
import tqdm
import time
res_path = "/Users/shashanksingh/Desktop/India_air/q4responses/"
