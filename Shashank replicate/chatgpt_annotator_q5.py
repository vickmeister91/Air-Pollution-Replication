...
question = "In the following judgement order summary, predict on a scale of 0-100 if the case is relevant to the environment where 100 is the most environmentally relevant. Give a number from 0 to 100 and then give the reason separated from the binary answer with a colon. The order is as follows - "
...
# list_paths = glob.glob(wd+r"/q5responses/*.txt")
list_done = []
# for path in list_paths:
